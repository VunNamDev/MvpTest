...
import com.example.mpvtest.BuildConfig;
...
public class GlobalFun {
    ...
    public void moreApp(Context context) {
        Uri uri = Uri.parse("https://play.google.com/store/apps/developer?id=" + context.getString(R.string.more_app_key_word)); // missing 'http://' will cause crashed
